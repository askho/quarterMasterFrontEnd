...
jQuery.sap.declare("components.disabled.Component");

// new Component
sap.ui.core.UIComponent.extend("components.disabled.Component", {
...
components.disabled.Component.prototype.createContent = function(){
